...
Write a function called sum() that takes in two numbers as arguments and then returns an array where the first element is the sum of those numbers, and 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    let firstTotal = sum(a,b);
    let finalTotal = sum(firstTotal[0],c);
    let firstProduct = multiply(a,b);
    let finalProduct = multiply(firstProduct[0],c);
    return [finalTotal[0], finalProduct[0],`${a} and ${b} and ${c} sum to ${finalTotal[0]}.`,`The product of ${a} and ${b} and ${c} is ${finalProduct[0]}.`];
};
...
/////////////////////////////////////
/* Problem 4
Write a function called sumArray() that takes in an array of numbers as its single argument and then returns an array where the first element is the sum of the numbers in the array, and 
...
IMPORTANT DETAIL: You may not use the arithmetic operator + in this function. To do addition, use your sum() function that you've already created. You're going to have to be resourceful 
...
function sumArray(sumArr) { //eslint-disable-line
    let sumFirstTwo = sum(sumArr[0], sumArr[1]);
    let sumTotal = sum(sumFirstTwo[0], sumArr[2]);
    return [sumTotal[0], `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${sumTotal[0]} is their sum.`];
};
...
However, you may continue to use the 
...
function multiplyArray(multArr) { //eslint-disable-line
    let firstMulti = multiply(multArr[0],multArr[1]);
    let finalMulti = multiply(firstMulti[0],multArr[2]);
    return [finalMulti[0], `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${finalMulti[0]}.`]; 
};
